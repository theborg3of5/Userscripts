This script just defaults some values into the Completionator Bulk Import page, to make adding the weekly free games from the Epic Games store a little easier to enter.
